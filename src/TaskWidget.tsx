...
function AvatarStack({
  ...
  return (
    ...
    >
      ...
      <div
        className="relative rounded-full border-2 border-white shrink-0 flex items-center justify-center overflow-hidden"
        style={{
          width: 20,
          height: 20,
          background: "#f7f7f7",
...
function TaskRow({
  ...
  return (
    <motion.div
      ...
      transition={
        reduced ? { duration: 0.15 } : { ...SPRING_ENTRY, delay: delayS }
      }
    >
      <div
        className="flex items-center gap-2 min-h-px min-w-px"
        style={{ flex: "1 0 0" }}
      >
        <Checkbox
          checked={checked}
      ...
      <div
        className="flex items-center justify-center px-[6px] py-[2px] rounded-[8px] shrink-0 ml-2"
...
export default function TaskWidget() {
  ...
  const calendarCloseRef = useRef<HTMLButtonElement>(
    null,
  ) as React.MutableRefObject<HTMLButtonElement>;
  const guestsCloseRef = useRef<HTMLButtonElement>(
    null,
  ) as React.MutableRefObject<HTMLButtonElement>;
        ...
        {view === "closed" ? (
          ...
          >
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={
                reduced ? { duration: 0.15 } : { ...SPRING_ENTRY, delay: 0.08 }
              }
            >
              <p
